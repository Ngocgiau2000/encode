...
# dear my friend..
# for decrypt back your encrypt file, just command:
# cat <encrypt.sh hare> | tr ';' '\n' | grep 'RzE=' | cut -d '"' -f2 | tr ' ' '\n' | rev | base64 -d >> decrypt-ori.sh
